...
function Womencmp() {
    ...
    const [count]= useFetch("https://fakestoreapi.com/products/category/women's%20clothing")
    ...
    return (
        <>
            <div className="container my-5 ">
                <h2 className="text-center text-dark fw-bold mb-4">Women's clothing</h2>
